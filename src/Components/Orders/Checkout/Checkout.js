...
class  Checkout extends Component{
    ...
    submitHandler = () =>{
        ...
        axios.post("https://burger-builder-63912-default-rtdb.firebaseio.com/orders.json", order)
        .then(response =>{
            ...
            <div>
                ...
                <form style={{
                    ...
                    <textarea name="deliveryAddress"
                     value={this.state.values.deliveryAddress} className="form-control" 
                     placeholder="Your Address" onChange={(e) =>this.inputChangeHandler(e)}>
                    </textarea>
                    <br/>
